...
;(function( window ) {
  ...
  Memory.prototype.options = {
   ...
   cards : [
          {
            id : 1,
            img: "img/banjonborno/b1.png"
          },
          {
            id : 2,
            img: "img/banjonborno/b2.png"
          },
          {
            id : 3,
            img: "img/banjonborno/b3.png"
          },
          {
            id : 4,
  ...
  Memory.prototype._setupGame = function() {
    ...
    this.gameStartScreenHTML = '<h2 class="mg__start-screen--heading"></h2>\
      <p class="mg__start-screen--text">ব্যাঞ্জনবর্ণের চিত্র সম্বলিত টাইলগুলো উলটে দিন এবং একই অক্ষরযুক্ত টাইল জোড়া বানান। বোর্ডে উপস্থিত সকল টাইল জোড়া হিসেবে উপস্থাপিত হলে খেলা সমাপ্ত হবে। যত কম সংখ্যক খেলার দানের মাধ্যমে সম্ভব খেলা সমাপ্ত করুন।</p>\
