...
function init()
{
    ...
    {
		 //alert('hi');
		 localStorage.setItem('xvalue','1');
	}
	document.getElementById(localStorage.getItem('xvalue')).style.backgroundColor = "red";
	var img2_src='img/BIG_bn'+localStorage.getItem('xvalue')+'.png';
	document.getElementById("myLtr").src = img2_src;
	
	var img_src='images/ban'+localStorage.getItem('xvalue')+'_1.gif';
	document.getElementById("sb1_img").src = img_src;
	
	
    document.getElementById("cholo_lk").href='anam_1_clb_'+localStorage.getItem('xvalue')+'.html';
    document.getElementById("cholo_sk").href='anam_1_asb_'+localStorage.getItem('xvalue')+'.html';
	
	 if(localStorage.getItem('xvalue'))
     {
		   if(parseInt(localStorage.getItem('xvalue'))>36)
		   {
			   $('.carousel').carousel(6);
		   }
		   else if(parseInt(localStorage.getItem('xvalue'))>30)
		   {
			   $('.carousel').carousel(5);
		   }
		   else if(parseInt(localStorage.getItem('xvalue'))>24)
		   {
			   $('.carousel').carousel(4);
		   }
		   else if(parseInt(localStorage.getItem('xvalue'))>18)
		   {
			   $('.carousel').carousel(3);
		   }
		   else if(parseInt(localStorage.getItem('xvalue'))>12)
		   {
			   $('.carousel').carousel(2);
		   }
		   else if(parseInt(localStorage.getItem('xvalue'))>6)
		   {
			   $('.carousel').carousel(1);
		   }
    }
...
function select_letter(x)
{
   ...
   // },0);	
	...
	document.getElementById( localStorage.getItem('xvalue')).style.backgroundColor = "#3A72B8";
	document.getElementById( localStorage.getItem('xvalue')).style.backgroundColor = "#3A72B8";
	...
	/*var lekhi='anam_1_clb_'+localStorage.getItem('xvalue')+'.html';
    document.getElementById("cholo_lk").href=lekhi;
    var shikhi='anam_1_asb_'+localStorage.getItem('xvalue')+'.html';
    document.getElementById("cholo_sk").href=shikhi;*/
	
	//selected=localStorage.getItem('xvalue');	
...
//################################################################################## item 1 ########################################################################//
	if( localStorage.getItem('xvalue')==1)
	{
	   // <!--     --------------------  AUDIO ---------------------    -->
	  setTimeout(function() {
      sound1_1.play();
      ...
      sound1.play();
       ...
       setTimeout(function(){
        ...
        $('#refresh_button').click(function() {
            //location.reload();
            document.getElementById( localStorage.getItem('xvalue')).style.backgroundColor = "red";
            select_letter( localStorage.getItem('xvalue'));
            sb_animation();
        });
        ...
        function new_anam_1(){
            ...
            setTimeout(function() {$("#sp1_anam").fadeOut();}, 7000); 
...
//################################################################################## item 2 ########################################################################//
    if( localStorage.getItem('xvalue')==2)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
        setTimeout(function() {
      sound2_1.play();
...
//################################################################################## item 3 ########################################################################//
    if( localStorage.getItem('xvalue')==3)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
        setTimeout(function() {
      sound3_1.play();
...
//################################################################################## item 4 ########################################################################//
    if( localStorage.getItem('xvalue')==4)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
        setTimeout(function() {
      sound4_1.play();
...
//################################################################################## item 5 ########################################################################//
    if( localStorage.getItem('xvalue')==5)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
        setTimeout(function() {
      sound5_1.play();
      ...
      sound5.play();
        ...
        function new_anam_5(){
            ...
            setTimeout(function() {document.getElementById("sp1_2_anam").style.color="red";}, 4000);
...
//################################################################################## item 6 ########################################################################//
    if( localStorage.getItem('xvalue')==6)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound6_1.play();
...
//################################################################################## item 7 ########################################################################//
    if( localStorage.getItem('xvalue')==7)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound7_1.play();
...
//################################################################################## item 8 ########################################################################//
    if( localStorage.getItem('xvalue')==8)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound8_1.play();
...
//################################################################################## item 9 ########################################################################//
    if( localStorage.getItem('xvalue')==9)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound9_1.play();
...
//################################################################################## item 10 ########################################################################//
    if( localStorage.getItem('xvalue')==10)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound10_1.play();
...
//################################################################################## item 11 ########################################################################//
    if( localStorage.getItem('xvalue')==11)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound11_1.play();
...
//################################################################################## item 12 ########################################################################//
    if( localStorage.getItem('xvalue')==12)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound12_1.play();
...
//################################################################################## item 13 ########################################################################//
    if( localStorage.getItem('xvalue')==13)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound13_1.play();
...
//################################################################################## item 14 ########################################################################//
    if( localStorage.getItem('xvalue')==14)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound14_1.play();
...
//################################################################################## item 15 ########################################################################//
    if( localStorage.getItem('xvalue')==15)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound15_1.play();
...
//################################################################################## item 16 ########################################################################//
    if( localStorage.getItem('xvalue')==16)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound16_1.play();
...
//################################################################################## item 17 ########################################################################//
    if( localStorage.getItem('xvalue')==17)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound17_1.play();
 ...
 //################################################################################## item 18 ########################################################################//
    if( localStorage.getItem('xvalue')==18)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound18_1.play();
 ...
 //################################################################################## item 19 ########################################################################//
    if( localStorage.getItem('xvalue')==19)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound19_1.play();
 ...
 //################################################################################## item 20 ########################################################################//
    if( localStorage.getItem('xvalue')==20)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound20_1.play();
 ...
 //################################################################################## item 21 ########################################################################//
    if( localStorage.getItem('xvalue')==21)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound21_1.play();
 ...
 //################################################################################## item 22 ########################################################################//
    if( localStorage.getItem('xvalue')==22)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound22_1.play();
 ...
 //################################################################################## item 23 ########################################################################//
    if( localStorage.getItem('xvalue')==23)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound23_1.play();
 ...
 //################################################################################## item 24 ########################################################################//
    if( localStorage.getItem('xvalue')==24)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound24_1.play();
 ...
 //################################################################################## item 25 ########################################################################//
    if( localStorage.getItem('xvalue')==25)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound25_1.play();
 ...
 //################################################################################## item 26 ########################################################################//
    if( localStorage.getItem('xvalue')==26)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound26_1.play();
 ...
 //################################################################################## item 27 ########################################################################//
    if( localStorage.getItem('xvalue')==27)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
      setTimeout(function() {
      sound27_1.play();
 ...
 //################################################################################## item 28 ########################################################################//
    if( localStorage.getItem('xvalue')==28)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound28_1.play();
 ...
 //################################################################################## item 29 ########################################################################//
    if( localStorage.getItem('xvalue')==29)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound29_1.play();
 ...
 //################################################################################## item 30 ########################################################################//
    if( localStorage.getItem('xvalue')==30)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound30_1.play();
      ...
      sound30.play();
        ...
        setTimeout(function() {
        document.getElementById("sb1_head2").innerHTML="<span id='sp1'><span id='sp1_1'>ষাঁ</span>ড় আসে</span><span id='sp2'> নদীর কূলে।</span>";      
         }, 0);
        ...
        function new_anam_30(){
            var d_text = "<span id='sp1_anam'><span id='sp1_1_anam'>ষাঁ</span><span id='sp1_2_anam'>ড়</span> </span>";
            setTimeout(function(){                
                document.getElementById('newText').innerHTML = d_text;
            }, 4000); 
            setTimeout(function() {document.getElementById("sp1_1_anam").style.color="red";}, 4000);
 ...
 //################################################################################## item 31 ########################################################################//
    if( localStorage.getItem('xvalue')==31)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound31_1.play();
 ...
 //################################################################################## item 32 ########################################################################//
    if( localStorage.getItem('xvalue')==32)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound32_1.play();
 ...
 //################################################################################## item 33 ########################################################################//
    if( localStorage.getItem('xvalue')==33)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound33_1.play();
 ...
 //################################################################################## item 34 ########################################################################//
    if( localStorage.getItem('xvalue')==34)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound34_1.play();
      ...
      sound34.play();
        ...
        setTimeout(function() {
        document.getElementById("sb1_head2").innerHTML="<span id='sp1'>আষা<span id='sp1_1'>ঢ়</span></span> <span id='sp2'> নামে।</span>";      
         }, 0);
        ...
        function new_anam_34(){
            var d_text = "<span id='sp1_anam'><span id='sp1_1_anam'>আষা</span><span id='sp1_2_anam'>ঢ়</span> </span>";
            setTimeout(function(){                
                document.getElementById('newText').innerHTML = d_text;
            }, 4000); 
            setTimeout(function() {document.getElementById("sp1_2_anam").style.color="red";}, 4000);
 ...
 //################################################################################## item 35 ########################################################################//
    if( localStorage.getItem('xvalue')==35)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound35_1.play();
      ...
      sound35.play();
        ...
        setTimeout(function() {
        document.getElementById("sb1_head2").innerHTML="<span id='sp1'>পা<span id='sp1_1'>য়</span>রা যায়</span> <span id='sp2'> ঘরের কোণে।</span>";      
         }, 0);
        ...
        function new_anam_35(){
            var d_text = "<span id='sp1_anam'><span id='sp1_1_anam'>পা</span><span id='sp1_a'>য়</span><span id='sp1_2_anam'>রা</span> </span>";
            setTimeout(function(){                
                document.getElementById('newText').innerHTML = d_text;
            }, 4000); 
            setTimeout(function() {document.getElementById("sp1_a").style.color="red";}, 4000);
 ...
 //################################################################################## item 36 ########################################################################//
    if( localStorage.getItem('xvalue')==36)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound36_1.play();
      ...
      sound36.play();
        ...
        function new_anam_36(){
            var d_text = "<span id='sp1_anam'><span id='sp1_1_anam'>উ</span><span id='sp_1_b'>ৎ</span><span id='sp1_2_anam'>সব</span> </span>";
            setTimeout(function(){                
                document.getElementById('newText').innerHTML = d_text;
            }, 4000); 
            setTimeout(function() {document.getElementById("sp_1_b").style.color="red";}, 4000);
 ...
 //################################################################################## item 37 ########################################################################//
    if( localStorage.getItem('xvalue')==37)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound37_1.play();
 ...
 //################################################################################## item 38 ########################################################################//
    if( localStorage.getItem('xvalue')==38)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
       setTimeout(function() {
      sound38_1.play();
 ...
 //################################################################################## item 39 ########################################################################//
    if( localStorage.getItem('xvalue')==39)
    {
       // <!--     --------------------  AUDIO ---------------------    -->
      setTimeout(function() {
      sound39_1.play();
      ...
      sound39.play();
        ...
        function new_anam_39(){
            var d_text = "<span id='sp1_anam'><span id='sp1_1_anam'>চাঁ</span><span id='sp1_2_anam'>দ</span> </span>";
            setTimeout(function(){                
                document.getElementById('newText').innerHTML = d_text;
            }, 4000); 
            setTimeout(function() {document.getElementById("sp1_1_anam").style.color="red";}, 4000);
