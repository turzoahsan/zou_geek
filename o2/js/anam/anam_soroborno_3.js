...
function init()
{
    ...
    {
		 localStorage.setItem('svalue','1');
	}
	document.getElementById(localStorage.getItem('svalue')).style.backgroundColor = "red";
	
	var img2_src='images/BIG_sb'+localStorage.getItem('svalue')+'.png';
	document.getElementById("myLtr").src = img2_src;

	var img_src='images/an'+localStorage.getItem('svalue')+'_1.gif';
	document.getElementById("sb1_img").src = img_src;

	var lekhi='anam_1_cl1_'+localStorage.getItem('svalue')+'.html';
    document.getElementById("cholo_lk").href=lekhi;

    var shikhi='anam_1_as1_'+localStorage.getItem('svalue')+'.html';
    document.getElementById("cholo_sk").href=shikhi;
	
	if(localStorage.getItem('svalue')){
		if(parseInt(localStorage.getItem('svalue'))>6)
	 	$('.carousel').carousel(1);
	}
...
function select_letter(x)
{
   ...
   // },0);	
	...
	document.getElementById(localStorage.getItem('svalue')).style.backgroundColor = "#3A72B8";
	document.getElementById(localStorage.getItem('svalue')).style.backgroundColor = "#3A72B8";
    ...
    var shikhi='anam_1_as1_'+x+'.html';
    document.getElementById("cholo_sk").href=shikhi;*/
	
	//selected=x;	
    document.getElementById(localStorage.getItem('svalue')).style.backgroundColor = "red";
	localStorage.setItem('svalue',x);
...
$('#myLtr').removeClass('letter_anm');
 ...
 document.getElementById("bigLtr").style.visibility = "none";
	...
	if(localStorage.getItem('svalue')==1)
	{
	// <!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound1_1.play();
      ...
      sound1.play();
        ...
        $('#refresh_button').click(function() {
            //location.reload();
            document.getElementById(localStorage.getItem('svalue')).style.backgroundColor = "red";
            select_letter(localStorage.getItem('svalue'));
            sb_animation();
        });
...
// ############################################ item 2 ########################################## //
	...
	if(localStorage.getItem('svalue')==2)
	{
//	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound2_1.play();
...
// ############################################ item 3 ########################################## //
	...
	if(localStorage.getItem('svalue')==3)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound3_1.play();
...
// ############################################ item 4 ########################################## //
	...
	if(localStorage.getItem('svalue')==4)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound4_1.play();
...
// ############################################ item 5 ########################################## //
	...
	if(localStorage.getItem('svalue')==5)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound5_1.play();
...
// ############################################ item 6 ########################################## //
	...
	if(localStorage.getItem('svalue')==6)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound6_1.play();
      ...
      document.getElementById("sp2").style.color="black";}, 2500);
       ...
       document.getElementById("sp1_1").style.color="red";},3500);
        ...
        function new_anam_6(){
            ...
            setTimeout(function() {$("#sp1_anam").fadeOut();}, 6000); 
            setTimeout(function() {$("#sp3_anam").fadeOut();}, 6000);  
...
// ############################################ item 7 ########################################## //
	...
	if(localStorage.getItem('svalue')==7)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound7_1.play();
      ...
      sound7.play();
		...
		setTimeout(function() {
     document.getElementById("sb1_head2").innerHTML="<span id='sp1'><span id='spS'><span id='sp1_1'>ঋ</span>তু</span> যায়।</span> <span id='sp2'><span id='spS'>&nbspঋতু</span> আসে।</span>";}, 0);

        setTimeout(function() {
     document.getElementById("sb1_head3").innerHTML="<span id='sp3'><span id='spS2'><span id='sp3_1'>ঋ</span>ষি</span> ওই</span> <span id='sp4'>বসে আছে।</span>"; 
        }, 4500);
...
// ############################################ item 8 ########################################## //
	...
	if(localStorage.getItem('svalue')==8)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound8_1.play();
      ...
      sound8.play();
		...
		setTimeout(function() {
     document.getElementById("sb1_head2").innerHTML="<span id='sp1'><span id='spS'>এ</span>কতারা বাজে। </span>";}, 0);
...
// ############################################ item 9 ########################################## //
	...
	if(localStorage.getItem('svalue')==9)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound9_1.play();
      ...
      document.getElementById("sp2").style.color="black";}, 2000);
       ...
       document.getElementById("sp1_1").style.color="red";},3000);
        ...
        function new_anam_9(){
            ...
            setTimeout(function() {$("#sp1_anam").fadeOut();}, 8000); 
            setTimeout(function() {$("#sp3_anam").fadeOut();}, 12000);  
...
// ############################################ item 10 ########################################## //
	...
	if(localStorage.getItem('svalue')==10)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound10_1.play();
...
// ############################################ item 11 ########################################## //
	...
	if(localStorage.getItem('svalue')==11)
	{
	<!--     --------------------  AUDIO ---------------------    -->
		setTimeout(function() {
      sound11_1.play();
